...
connection = pymysql.connect(host='localhost',user='root',password='4SF20CI031!m',db='cv')
...
st.set_page_config(
   ...
   page_icon=r"C:\Users\Asus\Desktop\Resume\Logo\logo2.png",
)
def run():
    img = Image.open(r"C:\Users\Asus\Desktop\Resume\Logo\logo2.png")
    ...
    if choice == 'User':
        ...
        if st.button('Login'):
            if ad_user == 'mansha' and ad_password == 'mansha123':
                st.success("Welcome  !")
                # Display Data
